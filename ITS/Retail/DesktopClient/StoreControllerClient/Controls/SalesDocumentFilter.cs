...
{
    public class SalesDocumentFilter: DocumentFilter
    {
        public SalesDocumentFilter() : base(Platform.Enumerations.eDivision.Sales, false)
        {
            SecondaryFilterControl = new SalesDocumentSecondaryFilterControl();
