...
{
    public partial class LeafletDetailFilter : BaseSearchableFilterControl
    {
        public LeafletDetailFilter()
        {
            InitializeComponent();
            CreateSearchFilter();
            this.SearchFilter.Set();
            SecondaryFilterControl = new LeafletDetailSecondaryFilterControl();
        ...
        protected virtual void CreateSearchFilter()
        {
            if (!DesignMode)
            {
                this.SearchFilter = new LeafletDetailSearchFilter() { Owner = Program.Settings.StoreControllerSettings.Owner.Oid };
            }
        }
