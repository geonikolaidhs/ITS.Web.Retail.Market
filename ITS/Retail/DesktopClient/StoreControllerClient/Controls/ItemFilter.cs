...
{
    public partial class ItemFilter : BaseFilterControl
    {
        public ItemFilter()
        {
            InitializeComponent();
            SecondaryFilterControl = new ItemSecondaryFilterControl();
        ...
        protected virtual void CreateSearchFilter()
        {
            if (!DesignMode)
            {
                this.SearchFilter = new ItemSearchFilter() { Owner = Program.Settings.StoreControllerSettings.Owner.Oid };
            }
        }
