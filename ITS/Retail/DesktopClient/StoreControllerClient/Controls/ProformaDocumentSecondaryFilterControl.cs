...
{
    public partial class ProformaDocumentSecondaryFilterControl : BaseSecondaryFilterControl
    {
        public ProformaDocumentSecondaryFilterControl()
        {
            InitializeComponent();
        ...
        private void searchLookUpEditDocumentCustomerFilter_Properties_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
