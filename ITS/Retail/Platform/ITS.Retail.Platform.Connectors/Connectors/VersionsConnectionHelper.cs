...
{
    public static class VersionsConnectionHelper
    {
        ...
        public const string ConnectionString = @"XpoProvider=SQLite;Data Source=POSVersions";
        ...
        private static IDataLayer GetDataLayer()
        {
            ...
            dict.GetDataStoreSchema(typeof(TableVersions).Assembly);
