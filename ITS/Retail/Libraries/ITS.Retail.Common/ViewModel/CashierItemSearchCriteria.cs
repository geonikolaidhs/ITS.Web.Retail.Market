...
{
    public class CashierSearchCriteria : BaseSearchFilter
    {
        ...
        public CashierSearchCriteria(POSDevice deviceSettings)
        {
            ...
            TimeValueFromDate = DateTime.Now.Date.AddDays(-1);
        ...
        protected override List<CriteriaOperator> BuildExtraCriteria()
        {
            ...
            CriteriaOperator baseValueCriteria = CriteriaOperator.And(
            ...
            CriteriaOperator timeValueStartCriteria = new ContainsOperator("TimeValues", new BetweenOperator("TimeValueValidFrom", valueDateFrom.Ticks, valueDateTo.Ticks));
            CriteriaOperator timeValueEndCriteria = new ContainsOperator("TimeValues", new BetweenOperator("TimeValueValidUntil", valueDateFrom.Ticks, valueDateTo.Ticks));

            if (WithTimeValueFilter)
            {
                list.Add(CriteriaOperator.Or(timeValueChangeCriteria, timeValueStartCriteria, timeValueEndCriteria, criteriaOfItem));
            }
            else
            {
