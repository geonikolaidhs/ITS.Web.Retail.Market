...
{
    /// <summary>
    /// For EAFDSS only. Opens a fiscal day ONLY at the device
    /// </summary>
    public class ActionServiceStartLegalReceiptFiscalPrinter : Action
    {
        public ActionServiceStartLegalReceiptFiscalPrinter(IPosKernel kernel)
            : base(kernel)
        {
        ...
        {
            get { return eActions.SERVICE_START_LEGAL_RECEIPT_FISCAL_PRINTER; }
        }
