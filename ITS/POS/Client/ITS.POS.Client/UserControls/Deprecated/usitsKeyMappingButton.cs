...
{
    [Obsolete("Key mappings are not set from the client. Class not removed for backwards compartibility. Excluded from designer")]
    public partial class usitsKeyMappingButton : BaseActionButton
    {
        public usitsKeyMappingButton()
        {
