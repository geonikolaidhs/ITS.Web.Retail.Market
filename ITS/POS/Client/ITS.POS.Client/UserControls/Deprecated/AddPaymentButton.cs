...
{
    [Obsolete("DO NOT RENAME OR CHANGE NAMESPACE FOR BACKWARDS COMPATIBILITY! Use AddTotalPaymentButton instead")]
    public partial class AddPaymentButton : ucitsButton
    {
        public string PaymentMethodCode { get; set; }


        public AddPaymentButton()
        {
