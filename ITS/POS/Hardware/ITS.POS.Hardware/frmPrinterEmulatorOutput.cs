...
namespace ITS.POS.Hardware
{
    ...
    /// </summary>
    public partial class frmPrinterEmulatorOutput : XtraForm
    {
        /// <summary>
        ...
        public frmPrinterEmulatorOutput()
        {
            InitializeComponent();
        }
        ...
        private void frmPrinterEmulatorOutput_FormClosing(object sender, FormClosingEventArgs e)
        {
            //this.Hide();
            //e.Cancel = true;
        }
