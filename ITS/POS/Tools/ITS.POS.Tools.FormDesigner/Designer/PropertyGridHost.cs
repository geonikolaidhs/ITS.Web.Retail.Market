...
namespace ITS.POS.Tools.FormDesigner
{
    public partial class PropertyGridHost : UserControl
    {
        ...
        private DesignSurfaceManager SurfaceManager { get; set; }
        ...
        //- ctor
        public PropertyGridHost(DesignSurfaceManager surfaceManager)
        {
        ...
        private string TranslateComponentToName(IComponent comp)
        {
        ...
        private void OrientPropertyGridTowardsObject()
        {
            ...
            foreach (IComponent comp in ctrlsExisting)
            {
        ...
        public void ReloadComboBox()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    foreach (var com in ctrlsExisting)
                    {
                        if (com is Component)
                        {
                            Component comp = (Component)com;
                            string sItemText = TranslateComponentToName(comp);
