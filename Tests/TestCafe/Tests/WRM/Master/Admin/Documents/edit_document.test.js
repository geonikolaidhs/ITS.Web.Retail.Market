...
"@page ./Home";
'@require ./../../../wrm_mixins/authentication.js';
...
"@test"["Edit Document Sales"] = {
  '@testCases': [
    {'@name': 'Admin', login: 'Admin', password: 'Aa123456', group: 'admin'}
    //{'@name': 'Customer', login: 'Customer', password: 'Aa123456', group: 'customer'},
    //{'@name': 'Supplier', login: 'Supplier', password: 'Aa123456', group: 'supplier'},
  ],
  ...
  'Search Documents' : '@mixin SearchDocumentsSales',
    ...
    "11.Assert Edit Form Opens": function() {
