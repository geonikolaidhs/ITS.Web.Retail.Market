...
namespace Common
{
    public class NewXmlParser
    {
        ...
        public string GetError()
        {
            try
            {
                GetAttributesOfRequest();
                if (ListOfAttributes[0].errorcode != "" || ListOfAttributes[0].errorcode != "0" || ListOfAttributes[0].errorcode != null)
                {
                    return ListOfAttributes[0].errordescr;
                }
                else
                    return "";
            }
