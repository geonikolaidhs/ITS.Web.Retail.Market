...
// 
namespace ITS.MobileAtStore.WRMMobileAtStore {
    ...
    public partial class WRMMobileAtStore : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public WRMMobileAtStore() {
            this.Url = "http://192.168.1.2/webclient/WRMMobileAtStore.svc";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IWRMMobileAtStore/GetStores", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlArrayAttribute(IsNullable=true)]
        [return: System.Xml.Serialization.XmlArrayItemAttribute(Namespace="http://schemas.datacontract.org/2004/07/ITS.MobileAtStore.ObjectModel")]
        public Warehouse[] GetStores(int id, [System.Xml.Serialization.XmlIgnoreAttribute()] bool idSpecified, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string ip) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetStores(int id, bool idSpecified, string ip, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public Warehouse[] EndGetStores(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((Warehouse[])(results[0]));
        }
    }
